...
from django.views import generic  # 从数据库数据前台渲染列表的操作比较简单重复，
...
def detail(request, question_id):
    ...
    try:
        ...
        # 写法1 choices = Choice.objects.filter(question_id=question.id)
    ...
    #     raise Http404()
    # 写法3
    # question = get_object_or__404(Question, id=question_id)
    # print(question)
